...
async function main() {
    ...
    const mimAddr = presaleKey.MIM_ADDRESS;
    const cccAddr = presaleKey.CCC_ADDRESS;
    const prismAddr = presaleKey.PRISM_ADDRESS;
    ...
    const testPrism = await ethers.getContractAt("TestPrism", prismAddr);
